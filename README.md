...
**6.** Enter your Account Secret and Account System Name where indicated at the top of the pasted-in code.  These are shown in the Portal on the Account -> Your Account page.  Hit the **Save and Deploy** button at the top right. You have to hit **Save and Deploy** every time you finish making any edits to the code in the window.
